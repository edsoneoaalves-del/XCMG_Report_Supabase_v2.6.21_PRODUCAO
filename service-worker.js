const CACHE='xcmg-report-v2.6.23-production';
const ASSETS=['./','index.html','css/style.css?v=2.6.22','js/app.js?v=2.6.22','manifest.json','icons/icon-192.png','icons/icon-512.png'];
